...
if { ![info exists period_days] } {
    set period_days [parameter::get -package_id $package_id -parameter DefaultPeriodDays]
} else {
    parameter::set_value -package_id $package_id -parameter DefaultPeriodDays -value $period_days
}
